...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference('Meeting.count') do
      post meetings_url, params: { meeting: { booking: @meeting.booking, user: @meeting.user } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { booking: @meeting.booking, user: @meeting.user } }
